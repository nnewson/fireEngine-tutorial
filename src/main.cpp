...
try
{
    ...
    // No layers or extensions are required for this first connection test.
    // Those become necessary later for features such as validation, surfaces,
    // windows, and platform portability enumeration.
